...
//     EXPECT_EQ(err.what(), std::out_of_range("Pointer is NULL"));
//   }
// }
...
TEST(ListTest, Quantity_1) {
  s21::list<int> my_list1(3);
  EXPECT_EQ(my_list1.quantity(), 0);
}
TEST(ListTest, Quantity_2) {
  s21::list<int> my_list1(3);
  my_list1.push_back(3);
  EXPECT_EQ(my_list1.quantity(), 1);
}
TEST(ListTest, Push_back_1) {
  s21::list<int> my_list1;
  my_list1.push_back(3);

  EXPECT_EQ(my_list1.size(), 1);
  EXPECT_EQ(my_list1.quantity(), 1);
}
TEST(ListTest, Push_back_2) {
  s21::list<int> my_list1(4);
  my_list1.push_back(3);

  EXPECT_EQ(my_list1.size(), 4);
  EXPECT_EQ(my_list1.quantity(), 1);
}

TEST(ListTest, Merge_10) {
  s21::list<int> my_list1 = {1, 3, 5, 7};
  s21::list<int> my_list2 = {2, 4, 6, 8};
  std::list<int> std_list1 = {1, 2, 3, 4, 5, 6, 7, 8};
  my_list1.merge(my_list2);
  EXPECT_EQ(my_list1.size(), 8);
  EXPECT_EQ(my_list1.quantity(), 8);
  EXPECT_TRUE(compare_lists(my_list1, std_list1));
}

TEST(ListTest, insert_many_1) {
  s21::list<int> my_list1 = {1, 2, 3};
  std::list<int> my_list2 = {4, 5, 6, 1, 2, 3};
  my_list1.insert_many(my_list1.begin(), 4, 5, 6);
  EXPECT_EQ(my_list1.size(), 6);
  EXPECT_EQ(my_list1.quantity(), 6);
  EXPECT_TRUE(compare_lists(my_list1, my_list2));
}

TEST(ListTest, insert_many_2) {
  s21::list<int> my_list1 = {1, 2, 3};
  std::list<int> my_list2 = {1, 2, 4, 5, 6, 3};
  my_list1.insert_many(my_list1.end(), 4, 5, 6);
  EXPECT_EQ(my_list1.size(), 6);
  EXPECT_EQ(my_list1.quantity(), 6);
  EXPECT_TRUE(compare_lists(my_list1, my_list2));
}

TEST(ListTest, insert_many_3) {
  s21::list<int> my_list1 = {1, 2, 3};
  std::list<int> my_list2 = {1, 4, 5, 6, 2, 3};
  my_list1.insert_many(my_list1.begin() + 1, 4, 5, 6);
  EXPECT_EQ(my_list1.size(), 6);
  EXPECT_EQ(my_list1.quantity(), 6);
  EXPECT_TRUE(compare_lists(my_list1, my_list2));
}

TEST(ListTest, insert_many_4) {
  s21::list<int> my_list1;
  std::list<int> my_list2 = {1, 2, 3};
  my_list1.insert_many(my_list1.begin(), 1, 2, 3);
  EXPECT_EQ(my_list1.size(), 3);
  EXPECT_EQ(my_list1.quantity(), 3);
  EXPECT_TRUE(compare_lists(my_list1, my_list2));
}

TEST(ListTest, insert_many_back) {
  s21::list<int> my_list1 = {1, 2, 3};
  std::list<int> my_list2 = {1, 2, 3, 4, 5, 6};
  my_list1.insert_many_back(4, 5, 6);
  EXPECT_EQ(my_list1.size(), 6);
  EXPECT_EQ(my_list1.quantity(), 6);
  EXPECT_TRUE(compare_lists(my_list1, my_list2));
}
...
TEST(ListTest, insert_many_front) {
  s21::list<int> my_list1 = {1, 2, 3};
  std::list<int> my_list2 = {4, 5, 6, 1, 2, 3};
  my_list1.insert_many_front(4, 5, 6);
  EXPECT_EQ(my_list1.size(), 6);
  EXPECT_EQ(my_list1.quantity(), 6);
  EXPECT_TRUE(compare_lists(my_list1, my_list2));
}

// TEST(ListTest, Merge_11) {
//   s21::list<int> my_list1(10);
//   s21::list<int> my_list2(10);
//   std::list<int> std_list1 = {1, 2, 3, 4, 5, 6, 7, 8};
//   my_list1.push_back(1);
//   my_list1.push_back(3);
//   my_list1.push_back(5);
//   my_list1.push_back(7);
//   my_list2.push_back(2);
//   my_list2.push_back(4);
//   my_list2.push_back(6);
//   my_list2.push_back(8);
//   my_list1.merge(my_list2);

//   EXPECT_EQ(my_list1.size(), 20);
//   EXPECT_EQ(my_list1.quantity(), 8);
//   EXPECT_TRUE(compare_lists(my_list1, std_list1));
// }

// TEST(ListTest, Merge_12) {
//   s21::list<int> my_list1(10);
//   s21::list<int> my_list2(10);
//   std::list<int> std_list1 = {1, 2, 3, 4, 5, 6, 7, 8};
//   my_list1.push_back(1);
...
//   std_list1.erase(std_list1.begin().operator++());
